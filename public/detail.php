    ...
    <div class="col-sm-9">      
      ...
      <h4 class="text-warning">Giá bán: 
        ...
        <div class="row">
          ...
          <div class="col">
            <input type="submit" class="btn btn-warning" value="Chọn mua">
          </div>
        </div>		
    	</form>  	  
  	  </div>
      ...
      <div>
        <h4 class="text-warning">Mô tả sản phẩm: </h4>
    ...
    <div class="col-sm-3"> 
      ...
      <div>
        ...
        <div class="card h-100 shadow">
            ...
            <div class="badge bg-danger text-dark position-absolute" style="top: 0.5rem; right: 0.5rem">Giảm giá</div>
            <?php } // end if ?>
            <!-- Product image-->
            ...
            <div class="card-body p-4">
                <div class="text-center">
                    <!-- Product name-->
                    <a class="text-decoration-none" href="?action=detail&id=<?php echo $m["id"]; ?>"><h5 class="fw-bolder text-dark"><?php echo $m["tenmathang"]; ?></h5></a>
                    <!-- Product reviews-->
            ...
            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                <div class="text-center"><a class="btn btn-outline-warning mt-auto" href="index.php?action=chovaogio&id=<?php echo $d["id"]; ?>">Chọn mua</a></div>
            </div>
        </div>
    </div>
