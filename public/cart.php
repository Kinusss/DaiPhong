...
<h3 class="text-warning">Giỏ hàng của bạn trống!</h3>
<p>Vui lòng chọn sản phẩm mà bạn muốn ! </p>    
<?php 
} 
else{ 
?>
<h3 class="text-warning">Giỏ hàng của bạn:</h3>
...
<div class="row">
    <div class="col"><a href="index.php?action=xoagiohang">Xóa tất cả or trả số lượng về không</a></div>
    <div class="col text-end">    
    <input type="hidden" name="action" value="capnhatgio">
    <input type="submit" class="btn btn-warning" value="Cập nhật">
    <a href="index.php?action=thanhtoan" class="btn btn-warning">Thanh toán</a>
    </div>
</div>
</form>
<?php } // end if ?>
