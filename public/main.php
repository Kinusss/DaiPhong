...
foreach($danhmuc as $d){ 
    $i = 0;
?>
<h3><a class="text-decoration-none text-warning" href="index.php?action=group&id=<?php echo $d["id"]; ?>">
        ...
        <div class="card h-100 shadow">
            ...
            <div class="card-body p-4">
                <div class="text-center">
                    <!-- Product name-->
                    <a class="text-decoration-none" href="index.php?action=detail&id=<?php echo $m["id"]; ?>"><h5 class="fw-bolder text-dark"><?php echo $m["tenmathang"]; ?></h5></a>
                    <!-- Product reviews-->
            ...
            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                <div class="text-center"><a class="btn btn-outline-warning mt-auto" href="index.php?action=chovaogio&id=<?php echo $m["id"]; ?>">Chọn mua</a></div>
            </div>
        </div>
    </div>
<?php
